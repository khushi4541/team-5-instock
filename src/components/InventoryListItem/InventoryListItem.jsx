...
function InventoryListitems({ inventories, handleDeleteClick }) {
  const statusClass =
    ...
    <article className="items">
      ...
      <div className="items__icons">
        ...
        <button
          ...
          onClick={() => handleDeleteClick(inventories)}
          aria-label={`Delete ${inventories.item_name}`}
        >
          <svg
        ...
        {/* Edit Button */}
        <Link
          to={`/inventory/${inventories.id}/edit`}
          className="items__edit-btn"
          aria-label={`Edit ${inventories.item_name}`}
        >
          <svg
            className="items__icon"
            width="24"
