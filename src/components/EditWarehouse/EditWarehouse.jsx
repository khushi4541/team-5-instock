  ...
  return (
    <section className="edit-warehouse">
      <header className="edit-warehouse__header">
        <button className="edit-warehouse__back-button" onClick={handleBack}>
          <svg className="edit-warehouse__arrow"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="none"
      ...
      <div className="edit-warehouse__content">
        ...
        <div className="edit-warehouse__section edit-warehouse__section--border">
